...
class RideRequest {
  ...
  String get pickup => sourceAddress;

  // Getter for destination location
  String get destinationLocation => destinationAddress;
  ...
  factory RideRequest.fromMap(Map<dynamic, dynamic> map) {
    return RideRequest(
      ...
      source: map['source'] != null
          ? LatLng(map['source']['latitude'], map['source']['longitude'])
          : null,
      ...
      timestamp: map['timestamp'] ?? 0, // Default to 0 if not provided
    );
  }
